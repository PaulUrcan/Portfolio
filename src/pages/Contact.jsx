  ...
  return (
    <>
      ...
      <div className={`flex flex-col w-full h-screen justify-center items-center gap-5 transition-opacity duration-500 ease-in ${showBody ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className='flex md:flex-row flex-col font-medium text-2xl gap-4 md:gap-3 text-orange-600 md:text-orange-300'>
          <div className='rounded-full p-5 bg-gray-300 md:bg-inherit md:shadow-none shadow-md shadow-gray-700'>
          ...
          <Link to='/mail' className='rounded-full p-5 bg-gray-300 md:bg-inherit md:shadow-none shadow-md shadow-gray-700'>
